...
public class ModelItens implements MVPItens.ModelItens {
    private EstablishmentService mTService;
    private MVPItens.PresenterItens mPresenter;
    private Context ctx;

    public ModelItens(MVPItens.PresenterItens mPresenter) {
    ...
    public void retrieveItens() {
        Call<List<Promotion>> call = mTService.getPromotions();
