...
import com.example.tiago.establishmentexample.product.ModelProducts;
...
public class PresenterShop implements MVP.PresenterShop {
    private List<Product> mProducts = new ArrayList<>();
    private MVP.ModelShop model;
    private MVP.ViewShop view;
    private Context context;

    public PresenterShop(Context context) {
        this.context = context;
        model = new ModelShop(this);
    }
