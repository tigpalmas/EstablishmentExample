...
public class DialogGetItenFragment extends android.support.v4.app.DialogFragment {
    ...
    public static DialogGetItenFragment novaInstancia(Product product) {
        Bundle parametros = new Bundle();
        parametros.putSerializable(EXTRA_PRODUCT, product);
        DialogGetItenFragment fragment = new DialogGetItenFragment();
